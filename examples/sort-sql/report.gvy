...
INSERT INTO cars(name, price) VALUES('Volkswagen', 18600);
INSERT INTO cars(name, price) VALUES('Volkswagen', 20600);
'''
...
Sql.withInstance(url) { sql ->
    ...
    def rs = sql.query("SELECT * FROM cars ORDER BY name DESC, price ASC") { rs -> 
